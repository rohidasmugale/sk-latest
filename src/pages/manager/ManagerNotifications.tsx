...
const ManagerNotifications = () => {
  ...
  const handleExportNotifications = () => {
    try {
      ...
      link.setAttribute('download', `manager-notifications-${new Date().toISOString().split('T')[0]}.json`);
      link.click();
  ...
  return (
    ...
    >
                  ...
                  <AnimatePresence mode="wait">
                    {isRefreshing ? (
                      ...
                      <motion.div variants={staggerContainer} initial="initial" animate="animate" className="space-y-6">
                        {/* Unread – same as supervisor version, to avoid duplication I'll keep the same structure but it's fine */}
                        ...
                        {/* Read – same as above (omitted for brevity but can be duplicated) */}
      ...
      {/* DETAIL DIALOG – same as Supervisor version */}
